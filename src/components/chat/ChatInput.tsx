...
const ChatInput = () => {
  return (
    <div className="self-stretch inline-flex justify-center items-center gap-2.5">
      <div className="w-16 h-16 px-5 py-3.5 bg-zinc-100 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-neutral-200 flex justify-center items-center gap-2.5 overflow-hidden hover:bg-zinc-200 transition-colors cursor-pointer">
      ...
      <div className="w-[856px] h-16 p-5 bg-zinc-100 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-neutral-200 flex justify-start items-center gap-2.5 overflow-hidden hover:bg-zinc-50 transition-colors">
        <div className="w-[816px] flex justify-between items-center">
          <div className="w-48 flex justify-start items-center gap-3.5">
            ...
            <div className="justify-center text-neutral-500 text-base font-normal font-['Poppins']">Ask to Multilingual...</div>
          </div>
          <div className="flex justify-start items-center gap-2.5">
            ...
            <svg className="w-5 h-7" viewBox="0 0 21 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M5.35742 30.1428H15.6431" stroke="#0027ED" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
      </div>
