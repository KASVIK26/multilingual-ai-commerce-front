...
const ChatInput = ({ message, setMessage, onSendMessage, disabled }: ChatInputProps) => {
  ...
  return (
    <div className="self-stretch inline-flex justify-center items-center gap-2.5">
      <div className="w-16 h-16 px-5 py-3.5 bg-zinc-100 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-neutral-200 flex justify-center items-center gap-2.5 overflow-hidden">
