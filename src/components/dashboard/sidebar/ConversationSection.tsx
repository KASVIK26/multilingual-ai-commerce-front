  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-3.5">
        ...
        <div className="px-2.5 py-3 bg-stone-50 rounded-2xl outline outline-1 outline-offset-[-1px] outline-stone-300/30 flex flex-col gap-2.5">
          <div className="flex flex-col">
            <div className="h-9 px-2.5 py-[5px] bg-gray-200 rounded-lg flex flex-col justify-center items-center gap-2.5 group relative">
            ...
            {conversationItems.slice(1).map((item) => (
              <button
                key={item}
                className="h-9 px-2.5 py-[5px] rounded-lg flex flex-col justify-center items-center gap-2.5 hover:bg-gray-100 transition-all duration-200 hover:scale-[1.02]"
              >
                <div className="flex justify-between items-center w-full">
                  <div className="text-black text-sm font-normal font-['Poppins']">
                    {item}
