...
const Sidebar = () => {
  ...
  return (
    <div className="w-80 h-screen bg-stone-300/20 rounded-2xl outline outline-1 outline-offset-[-1px] outline-gray-200 overflow-hidden relative flex-shrink-0">
      <style>
        {`
      ...
      <div className="w-72 mx-auto h-full overflow-y-auto sidebar-scroll flex flex-col gap-6 relative z-10 py-5">
        <SidebarHeader />
