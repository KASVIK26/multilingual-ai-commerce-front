...
const Dashboard = () => {
  ...
  return (
    <div className="w-screen h-screen relative bg-stone-50 overflow-hidden flex">
      {/* Sidebar */}
      ...
      <div className="flex-1 flex flex-col min-w-0 p-5 pl-0">
        ...
        <div className="w-full mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Voice Orders Card */}
          <div className="h-[156px] px-2.5 py-3 relative bg-neutral-50 hover:bg-slate-950 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-neutral-200 hover:outline-black flex flex-col justify-start items-start gap-2.5 overflow-hidden transition-all duration-300 group">
            <div className="self-stretch flex justify-between items-start">
              <div className="flex flex-col justify-center items-start gap-2.5 flex-1">
                ...
                <div className="text-black group-hover:text-white text-4xl font-medium font-['Poppins'] transition-colors">17</div>
                <div className="flex justify-start items-center gap-[5px]">
                  <div className="px-[5px] py-[3px] bg-lime-200 group-hover:bg-lime-300 rounded-[5px] flex flex-col justify-center items-center gap-2.5 overflow-hidden transition-colors">
                    <div className="flex justify-start items-center gap-[5px]">
                      ...
                      <div className="text-green-700 group-hover:text-green-800 text-[10px] font-medium font-['Poppins'] transition-colors">+15%</div>
                    </div>
                  </div>
                  <div className="text-neutral-500 group-hover:text-neutral-400 text-[10px] font-normal font-['Poppins'] transition-colors">last month</div>
                </div>
              </div>
            ...
            <div className="absolute right-4 bottom-4 flex justify-start items-end gap-1">
        ...
        {/* Charts Section */}
        <div className="w-full mb-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Revenue Chart */}
          <div className="h-64 relative bg-neutral-50 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-neutral-200 overflow-hidden">
            {/* Bottom Line */}
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 h-80 relative bg-neutral-50 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-neutral-200 overflow-hidden">
            {/* Header */}
          ...
          {/* Quick Alerts */}
          <div className="h-80 relative bg-neutral-50 rounded-[10px] outline outline-1 outline-offset-[-1px] outline-neutral-200 overflow-hidden">
